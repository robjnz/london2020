...
.read-more-warrooms-label:after {
  content: "More";
  display: inline-block;
}
...
.read-more-warrooms:checked + .read-more-content + .read-more-warrooms-label:after {
  content: "Less";
}
</style>
